...
namespace Converter
{
    public partial class MainForm : Form
	{
		...
		private void btnStart_Click(object sender, EventArgs e)
		{
			...
			string schemaName = txtSqlServerSchema.Text.Trim();
			bool importData = chkImportData.Checked;
			...
			SqlServerToSQLite.ConvertSqlServerToSQLiteDatabase(sqlConnString, sqlitePath, password, handler,
				selectionHandler, viewFailureHandler, cbxTriggers.Checked, createViews, schemaName, importData);
		}
